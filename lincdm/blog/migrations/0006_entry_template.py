...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_entry', 'template', self.gf('django.db.models.fields.CharField')(default='blog/entry_detail.html', max_length=250), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Entry.template'
        db.delete_column('blog_entry', 'template')
