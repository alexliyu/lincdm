...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_entry', 'pingback_enabled', self.gf('django.db.models.fields.BooleanField')(default=True, blank=True))

    def backwards(self, orm):

        # Deleting field 'Entry.pingback_enabled'
        db.delete_column('blog_entry', 'pingback_enabled')
