...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_latestentriesplugin', 'template_to_render', self.gf('django.db.models.fields.CharField')(default='blog/cms/entry_list.html', max_length=250, blank=True), keep_default=False)

        # Adding field 'SelectedEntriesPlugin.template_to_render'
        db.add_column('cmsplugin_selectedentriesplugin', 'template_to_render', self.gf('django.db.models.fields.CharField')(default='blog/cms/entry_list.html', max_length=250, blank=True), keep_default=False)
