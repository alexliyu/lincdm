...
from lincdm.blog.views.tags import tag_detail
from lincdm.blog.views.authors import author_detail
from lincdm.blog.views.categories import category_detail
from lincdm.blog.tests.urls import urlpatterns as test_urlpatterns
