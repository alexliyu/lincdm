...
class EntryFeed(entryFeed):
    ...
    def item_author_link(self, item):
        ...
        try:
            author_url = reverse('entry_author_detail',
...
class AuthorEntries(EntryFeed):
    ...
    def link(self, obj):
        """URL of the author"""
        return reverse('entry_author_detail', args=[obj.username])
...
class TagEntries(EntryFeed):
    ...
    def link(self, obj):
        """URL of the tag"""
        return reverse('entry_tag_detail', args=[obj.name])
...
class SearchEntries(EntryFeed):
    ...
    def link(self, obj):
        ...
        return '%s?pattern=%s' % (reverse('entry_entry_search'), obj)
...
class EntryDiscussions(entryFeed):
