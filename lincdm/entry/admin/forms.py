...
from lincdm.entry.admin.widgets import TreeNodeChoiceField
from lincdm.entry.admin.widgets import MPTTFilteredSelectMultiple
from lincdm.entry.admin.widgets import MPTTModelMultipleChoiceField
