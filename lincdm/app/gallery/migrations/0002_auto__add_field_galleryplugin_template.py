...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('galleryplugin', 'template', self.gf('django.db.models.fields.CharField')(default='gallery/gallery.html', max_length=255), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GalleryPlugin.template'
        db.delete_column('galleryplugin', 'template')
    ...
    models = {
        ...
        'gallery.galleryplugin': {
            'Meta': {'object_name': 'GalleryPlugin', 'db_table': "'galleryplugin'", '_ormbases': ['cms.CMSPlugin']},
        ...
        'gallery.image': {
            ...
            'gallery': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['gallery.GalleryPlugin']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
