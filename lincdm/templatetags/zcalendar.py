"""Calendar module for entry templatetags"""
...
class entryCalendar(HTMLCalendar):
    ...
    def formatday(self, day, weekday):
        ...
        if day and day in self.day_entries:
            ...
            archive_day_url = reverse('entry_entry_archive_day',
        ...
        return super(entryCalendar, self).formatday(day, weekday)
    ...
    def formatmonth(self, theyear, themonth, withyear=True):
        ...
        return super(entryCalendar, self).formatmonth(
