...
from app.blog.templatetags.zbreadcrumbs import retrieve_breadcrumbs
...
@register.inclusion_tag('blog/tags/dummy.html')
def get_featured_entries(number=5, template='blog/tags/featured_entries.html'):
...
def get_calendar_entries(context, year=None, month=None,
    ...
    try:
        from app.blog.templatetags.zcalendar import blogCalendar
    except ImportError:
        return {'calendar':
