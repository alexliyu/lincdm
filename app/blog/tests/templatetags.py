"""Test cases for blog's templatetags"""
...
from app.blog.templatetags.blog_tags import get_gravatar
from app.blog.templatetags.blog_tags import get_authors
from app.blog.templatetags.blog_tags import get_categories
from app.blog.templatetags.blog_tags import get_recent_entries
from app.blog.templatetags.blog_tags import get_random_entries
from app.blog.templatetags.blog_tags import blog_breadcrumbs
from app.blog.templatetags.blog_tags import get_popular_entries
from app.blog.templatetags.blog_tags import get_similar_entries
from app.blog.templatetags.blog_tags import get_recent_comments
from app.blog.templatetags.blog_tags import get_recent_linkbacks
from app.blog.templatetags.blog_tags import get_calendar_entries
from app.blog.templatetags.blog_tags import get_archives_entries
from app.blog.templatetags.blog_tags import get_featured_entries
from app.blog.templatetags.blog_tags import get_archives_entries_tree
...
class TemplateTagsTestCase(TestCase):
    ...
    def test_get_recent_entries(self):
        ...
        self.assertEquals(context['template'], 'blog/tags/recent_entries.html')
    ...
    def test_get_featured_entries(self):
        ...
        self.assertEquals(len(context['entries']), 0)
        self.assertEquals(context['template'], 'blog/tags/featured_entries.html')
    ...
    def test_get_random_entries(self):
        ...
        self.assertEquals(len(context['entries']), 0)
        self.assertEquals(context['template'], 'blog/tags/random_entries.html')
    ...
    def test_get_popular_entries(self):
        ...
        self.assertEquals(len(context['entries']), 0)
        self.assertEquals(context['template'], 'blog/tags/popular_entries.html')
    ...
    def test_get_similar_entries(self):
        ...
        self.assertEquals(len(context['entries']), 0)
        self.assertEquals(context['template'], 'blog/tags/similar_entries.html')
    ...
    def test_get_archives_entries(self):
        ...
        self.assertEquals(context['template'], 'blog/tags/archives_entries.html')
    ...
    def test_get_archives_tree(self):
        ...
        self.assertEquals(len(context['archives']), 0)
        self.assertEquals(context['template'], 'blog/tags/archives_entries_tree.html')
    ...
    def test_get_recent_comments(self):
        ...
        self.assertEquals(context['template'], 'blog/tags/recent_comments.html')
    ...
    def test_get_recent_linkbacks(self):
        ...
        self.assertEquals(context['template'], 'blog/tags/recent_linkbacks.html')
    ...
    def test_blog_breadcrumbs(self):
        ...
        self.assertEquals(context['breadcrumbs'][0].url, reverse('blog_entry_archive_index'))
        self.assertEquals(context['separator'], '/')
        self.assertEquals(context['template'], 'blog/tags/breadcrumbs.html')

        context = blog_breadcrumbs(source_context, '>', 'Weblog', 'custom_template.html')
        self.assertEquals(len(context['breadcrumbs']), 1)
